...
<body class="body-whole">
    ...
    <header>
        ...
        <div class="logo nav-logo">
            <a href="#"><img src="../assets/img/home-logo.png" alt="Logo" width="200"></a>
        </div>

        <nav>
            <ul>
                <li><a href="#services" class="nav-change-color no-underline">Services</a></li>
                <li><a href="#about" class="nav-change-color no-underline">About</a></li>
                <li><a href="#contact" class="nav-change-color no-underline">Contact</a></li>
